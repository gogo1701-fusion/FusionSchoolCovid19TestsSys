...
namespace Covid19_automation_test
{
	class Grades
	{
		...
		{
			Name = "4Б",
			Students = Students.studentsInfosGis4B
		};

		public static GradeInfoStruct gis5A = new GradeInfoStruct()
		{
			Name = "5А",
			Students = Students.studentsInfosGis5A
		};
		...
		{
			Name = "6Б",
			Students = Students.studentsInfosGis6B
		};
